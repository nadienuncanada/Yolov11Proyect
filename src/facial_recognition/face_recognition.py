...
from src.facial_recognition.metadata import meta_clear_stored_images, meta_similarity_threshold, meta_model_name, meta_cant_max_imagenes
...
def run(etiqueta):
    ...
    while cap.isOpened():
        ...
        for res in results:
            ...
            etiqueta.after(0, etiqueta.config, {"text": final_text})  # Actualizar la etiqueta
